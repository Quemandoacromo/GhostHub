...
*(Note: The custom theme shown in the screenshots above is called "Oasis" in the [Community Theme Gallery](https://bleedingxiko.github.io/GhostHub_Themes/).)*
...
- Custom themes via the built-in Theme Builder and the [Community Theme Gallery](https://bleedingxiko.github.io/GhostHub_Themes/) ([GitHub Repo](https://github.com/BleedingXiko/GhostHub_Themes))
